...
`@prozilla-os/code-editor` is a code editor application for ProzillaOS.
...
```sh
npm install @prozilla-os/core @prozilla-os/code-editor
yarn add @prozilla-os/core @prozilla-os/code-editor
pnpm add @prozilla-os/core @prozilla-os/code-editor
```
...
import { codeEditor } from "@prozilla-os/code-editor";
...
[demo]: https://os.prozilla.dev/code-editor
[docs]: https://os.prozilla.dev/docs/reference/apps/code-editor
[github]: https://github.com/prozilla-os/ProzillaOS/tree/main/packages/apps/code-editor
[npm]: https://www.npmjs.com/package/@prozilla-os/code-editor
